...
insert into products (name, description, code, price, rating_id) values ('Rust', 'Overleef in de ruige wereld van Rust en vecht, of werk samen met naakte mensen.', '492662523-7', 40, 4);  
