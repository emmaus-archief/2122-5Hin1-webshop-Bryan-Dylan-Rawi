...
function getProducts(request, response) {
  ...
  let data = []
  const sqlOpdracht = db.prepare('SELECT products.id AS id, products.name AS name, products.description AS description, products.code AS code, products.price AS price, products.rating_id AS rating, products.genre_idAS genre, products.multiplayer_id AS multiplayer, products.studio_id AS studio FROM products JOIN leeftijd ON products.plat.id= products.plat.id ORDER BY id DESC')
